---
name: moo-git-commit
description: Use when writing git commit messages for GitHub-hosted moo projects. Covers Conventional Commit type prefixes, GitHub issue and pull request references, commit granularity rules, PR strategy, and branch management. Triggers when generating, reviewing, or fixing commit messages.
---
